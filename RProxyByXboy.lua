...
add_label_with_icon|big|`#========================|left|9474|
add_spacer|small|
add_textbox|`w▸ Version: `#V1.5 GENTA `w◂|
add_textbox|`w▸ Developer: `#XBOY `w◂|
add_textbox|`w▸ Total Commands: `#39+ Commands `w◂|
add_spacer|small|
...
add_smalltext|Version `#V1.5 GENTA|
add_spacer|small|
add_label_with_icon|small|`wMade by `#XBOY `w| `#39+ Commands|left|12436|
add_spacer|small|
...
add_spacer|small|
add_checkbox|realfakespin|`2REAL`0-`4FAKE `0Spin Detector|]]..tostring(rfspin and"1"or"0")..[[|
add_checkbox|gamereme|`^REME `0Spin Counter|]]..tostring(reme and"1"or"0")..[[|
